...
export default function Index() {
  ...
  const leftImgHeight = stageWidth * 0.5;
    ...
    >
      ...
      <View style={styles.container}>
        <ScrollView contentContainerStyle={styles.body}>
          ...
          <View
            style={[styles.frame2, { width: stageWidth, height: stageHeight }]}
          >
            <Image
            ...
            <Image
              ...
              style={[
                styles.rightImg,
                { width: rightImgSize, height: rightImgSize },
              ]}
              resizeMode="contain"
            />
            <Image
              ...
              style={[
                styles.leftImg,
                { width: leftImgWidth, height: leftImgHeight },
              ]}
              resizeMode="contain"
            />
          </View>
