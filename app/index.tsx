...
export default function Index() {
  ...
  const rightImgSize = stageWidth * 0.48; // increase this to make the right image larger
  const leftImgWidth = stageWidth * 0.52; // increase this to make the left image larger
  const leftImgHeight = stageWidth * 0.50;

  return (
    <ImageBackground
      source={require('../assets/images/backgrounds/index.png')}
      style={styles.bg}
      resizeMode="cover"
    >
      ...
      <ScrollView contentContainerStyle={styles.body}>
        ...
        <View style={styles.frame1}>
          <Image 
            source={require('../assets/images/components/index4.png')} 
            style={styles.topImg} 
            resizeMode="contain" 
            />
        </View>
